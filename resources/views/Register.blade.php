      ...
      @endif
        <div class="fields">
            <div class="input-field">
                ...
                <div class="inpt">
                    <input type="text" id="fn" name="First_Name" placeholder="Enter Your First Name"></div>
                    </dev>
                </div>
            <div class="input-field">
            ...
            <div class="input-field">
                ...
                <div class="inpt">
                    <input type="text" id="cemail" name="email_confirmation" placeholder="Enter Confirm E-mail" required>
                </div>
            </div>
            <div class="input-field">
                <label for="pw" >Password</label>
                <div class="inpt">
                    <input type="password" id="pw" name="password" placeholder="Enter Password" required>
                </div>
            </div>
            <div class="input-field">
                <label for="cpw" >Confirm Password</label>
                <div class="inpt">
                    <input type="password" id="cpw" name="password_confirmation"  placeholder="Enter Confirm Password" required>
                 </div>
            </div>
            ...
            <div class="input-field">
              <h2>Gender:</h2>
                <div class="rdio">
                    <input type="radio" id="rd-btn-1" class="mrgn" name="Gender" value="M">
                    <label for="rd-btn-1" >Male</label >
                    <input type="radio" id="rd-btn-2" class="mrgn" name="Gender" value="F">
                    <label for="rd-btn-2">Female</label >
                    <input type="radio" id="rd-btn-3" class="mrgn" name="Gender" value="O">
                    <label for="rd-btn-3" ">Others</label >
                </div>
            </div>
            <div class="input-field">
                <h2>Date Of Birth:</h2>
                <select  name="birthday_day" id="day" title="Day" class="days"><option value="1" >1</option>
                ...
                <option value="26">26</option><option value="27" selected="1">27</option><option value="28">28</option><option value="29">29</option>
                <option value="30">30</option><option value="31">31</option></select>
                <select name="birthday_month" id="month" title="Month" class="months" ><option value="1">Jan</option><option value="2">Feb</option>
                <option value="3">Mar</option><option value="4">Apr</option><option value="5">May</option><option value="6" selected="1">Jun</option>
                ...
                <select  name="birthday_year" id="year" title="Year" class="years"><option value="2023" selected="1">2023</option><option value="2022">2022</option>
            ...
            <div class="input-field">
                <label for="pn" >User Name</label>
                <div class="inpt">
                    <input type="text" id="pn" name="UserName" placeholder="Enter User Name">
                </div>
            </div>
                <div class="input-field">
